...
/**
 * Static functions which handle building themed UI elements for a provided NoteStyleEditorState.
 */
@:nullSafety @:access(funkin.ui.debug.charting.NoteStyleEditorState)
class NoteStyleEditorToolboxHandler
{
  public static function setToolboxState(state:NoteStyleEditorState, id:String, shown:Bool):Void
  {
    if (shown)
    {
