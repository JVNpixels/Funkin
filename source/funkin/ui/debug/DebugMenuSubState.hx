...
class DebugMenuSubState extends MusicBeatSubState
{
  ...
  override function create():Void
  {
    ...
    createItem("NOTESTYLE EDITOR", openNotestyleEditor);
    #end
  ...
  #if FEATURE_NOTESTYLE_EDITOR
  function openNotestyleEditor():Void
  {
    trace('NoteStyle Editor');
    FlxG.switchState(() -> new funkin.ui.debug.notestyle.NoteStyleEditorState());
  }
  #end
